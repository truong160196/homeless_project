    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'use' => [
            \LiamWiltshire\LaravelJitLoader\Concerns\AutoloadsRelationships::class,
            // Aris\Database\Eloquent\BitBooleans::class,
            // Aris\Database\Eloquent\BlamableBehavior::class,
        ],
        ...
        */
        ...
        'hidden' => [
            '*secret*', '*password', '*token', 'pivot', 'deleted_at',
        ],
