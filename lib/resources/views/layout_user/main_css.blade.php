...
<link rel="stylesheet" href="{{asset('assets/css_user/owl.carousel.css')}}">
<link rel="stylesheet" href="{{asset('assets/css_user/owl.theme.css')}}">
<link rel="stylesheet" href="{{asset('assets/css_user/slick.css')}}">
<link rel="stylesheet" href="{{asset('assets/css_user/slick-theme.css')}}">
<link rel="stylesheet" href="{{asset('assets/css_user/swiper.min.css')}}">
